...
`xhigh` is the peak. `max` actually drops. More compute is not always better. If you are setting effort programmatically, default to xhigh until you have evidence max helps your workload. I wrote about the adaptive-thinking breaking change behind this yesterday on [DEV.to](https://dev.to/jee599/opus-4-7-killed-budget-tokens).
...
If you missed the other breaking-change context from today's [Anthropic announcement](https://www.anthropic.com/news/claude-opus-4-7), my earlier post covers the tokenizer and adaptive-thinking side: [OpenAI's duct-tape GPT-Image-2 leak](https://dev.to/jee599/openai-duct-tape-gpt-image-2).
...
Read the Korean version on [spoonai.me](https://spoonai.me/posts/opus-4-7-system-card-findings). Follow me on [DEV.to](https://dev.to/jee599).
