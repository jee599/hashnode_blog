...
Two recruits stand out. Matt Botvinick comes from Yale Law School, where he's a resident fellow, and previously served as senior director of research at [Google DeepMind](https://deepmind.google/). He'll lead work on AI and the rule of law, studying how AI systems interact with existing legal frameworks.
...
Anton Korinek, an economics professor from the University of Virginia, joins to study how advanced AI reshapes economic activity. Zoe Hitzig comes from [OpenAI](https://openai.com/), where she studied AI's social and economic impacts. Her role is to connect economics research directly to model training and development. That connection matters. If economic research findings can influence how models are actually built and deployed, the Institute has a feedback loop that pure academic research doesn't.
...
[OpenAI](https://openai.com/) created the OpenAI Foundation during its for-profit transition, structurally separating the nonprofit mission from the commercial entity. The Anthropic Institute sits inside the company. That's a fundamental structural difference.
...
Full Korean analysis on [spoonai.me](https://spoonai.me/blog/2026-03-29-anthropic-institute-2026-ko). Also published on [DEV.to](https://dev.to/jee599/2026-03-29-anthropic-institute-2026-en).

---

- [Introducing The Anthropic Institute](https://www.anthropic.com/news/the-anthropic-institute) - Anthropic
- [Anthropic Launches Institute to Examine AI's Impact](https://www.eweek.com/news/anthropic-institute-launch-march-2026/) - eWeek
- [Anthropic launches an institute to tackle AI risks](https://siliconangle.com/2026/03/11/anthropic-launches-anthropic-institute-tackle-ai-risks/) - SiliconANGLE
- [New Anthropic Institute: Risks and Economic Effects](https://campustechnology.com/articles/2026/03/16/new-anthropic-institute-to-study-risks-and-economic-effects-of-advanced-ai.aspx) - Campus Technology
